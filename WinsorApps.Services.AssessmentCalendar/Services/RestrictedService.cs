...
public partial class AssessmentCalendarRestrictedService(ApiService api)
{
    ...
    public async Task<APExamSectionConflictReport?> GetAPConflicts(string examId, ErrorAction onError) =>
        await _api.SendAsync<APExamSectionConflictReport>(HttpMethod.Get, $"api/assessment-calendar/ap-exam/{examId}/conflicts", onError: onError);
